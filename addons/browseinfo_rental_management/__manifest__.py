...
{
    'name': 'Odoo Rental Management for Product/Item/Equipment/Vehicle',
    'summary': 'This appps helps to manage Service Rent,Product Rent,Vehical Rent, Car Rent, Machine rental system on Odoo',
...
==========================================
    ...
    'live_test_url':'https://youtu.be/NZXlleLEOmk',
    'author': 'BrowseInfo',
    'price': 69.00,
    'currency': "EUR",
    'application': True,
