...
class ResConfigSettings(models.TransientModel):
    ...
    # only_rental_details = fields.Boolean("rental order for only rental product", default = False)
    ...
    def get_values(self):
        ...
        res.update(
            ...
            # only_rental_details = get_param('browseinfo_rental_management.remainder_mail'),
    ...
    def set_values(self):
        ...
        # set_param('browseinfo_rental_management.only_rental_details', self.only_rental_details)
